...
const vehicles = {
  ...
  defaults: {
    ...
    isValidTarget: common.isValidTarget,
    findTargetsInSight: common.findTargetsInSight,
    ...
    moveTo: function(destination) {
      ...
      var
        dst_x = floor(destination.x),
        dst_y = floor(destination.y),
        start = [floor(this.x), floor(this.y)],
        end = [floor(destination.x), floor(destination.y)];
